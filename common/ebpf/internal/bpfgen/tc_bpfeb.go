...
const (
	...
	TCMapTcSocketBypass                  = "tc_socket_bypass"
	TCMapTcUidPolicy                     = "tc_uid_policy"
	TCProgSingboxTcDeliveryIngress       = "singbox_tc_delivery_ingress"
	TCProgSingboxTcLocalEgressEthernet   = "singbox_tc_local_egress_ethernet"
	TCProgSingboxTcLocalEgressRawIp      = "singbox_tc_local_egress_raw_ip"
...
type TCProgramSpecs struct {
	...
	SingboxTcLocalEgressEthernet   *ebpf.ProgramSpec `ebpf:"singbox_tc_local_egress_ethernet"`
	SingboxTcLocalEgressRawIp      *ebpf.ProgramSpec `ebpf:"singbox_tc_local_egress_raw_ip"`
...
type TCMapSpecs struct {
	...
	TcSocketBypass      *ebpf.MapSpec `ebpf:"tc_socket_bypass"`
...
type TCMaps struct {
	...
	TcSocketBypass      *ebpf.Map `ebpf:"tc_socket_bypass"`
...
type TCPrograms struct {
	...
	SingboxTcLocalEgressEthernet   *ebpf.Program `ebpf:"singbox_tc_local_egress_ethernet"`
	SingboxTcLocalEgressRawIp      *ebpf.Program `ebpf:"singbox_tc_local_egress_raw_ip"`
...
func (p *TCPrograms) Close() error {
	return _TCClose(
		...
		p.SingboxTcLocalEgressEthernet,
		p.SingboxTcLocalEgressRawIp,
